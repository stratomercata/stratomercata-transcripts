...
echo ""
echo "Available transcribers: whisperx, deepgram, assemblyai, revai, sonix, speechmatics"
echo "Available processors: anthropic, openai, gemini, deepseek, kimi, qwen3max, qwen"
echo ""
